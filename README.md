...
이 옵션은 다음 6시간 예보와 5일 예보 레일도 함께 숨깁니다.
...
```text
?city=부산&lat=35.1796&lon=129.0756&seconds=off&artSeconds=60&track=gymnopedie-loop&musicMode=shuffle&timerMinutes=25&alarm=07:30&restAfter=50&restMinutes=5&volume=0.4
```
...
- 5일 예보와 다음 6시간 예보는 모델 기반 참고 정보라 실제 관측과 다를 수 있습니다.
